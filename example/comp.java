...
public class comp implements compConstants {
  ...
  static final public void Linhas() throws ParseException {
    label_1:
    while (true) {
  ...
  static final public void Igualdade() throws ParseException {Token a, igual, b;
...
c.codigoList.add("Token: "+tokenImage[igual.kind]+" // Palavra: "+igual.toString());
    b = jj_consume_token(IDENTIFICADOR);
